      ...
      <div class="py-12 px-6 md:px-12">
        ...
        <div class="content flex flex-wrap md:flex-no-wrap mt-12">
          ...
          <div class="w-full md:w-2/5 mb-8">
            ...
            <a :href="publication.report.url" target="_blank"><appImage v-if="publication.thumbnail" :image="publication.thumbnail" size="large" class="thumbnail" />
            <img v-else class="thumbnail md:ltr:mr-6 md:rtl:ml-6 w-full" :src="placeholderImage" /></a>
          </div>
        </div>
      </div>
    </div>
